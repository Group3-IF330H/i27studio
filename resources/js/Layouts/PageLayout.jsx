    ...
    return (
        <>
            ...
            <div className="navbar">
                <div className="sidebar z-50 hidden lg:block md:fixed top-0 bottom-0 right-0 w-[300px] overflow-y-auto">
            ...
            <div className="flex items-center h-full cover md:mr-[300px] md:h-screen">
                <div className="container px-4 pt-20 md:px-0 md:py-0 md:ml-10 cover-item">
                    <motion.h1
                        initial={{ translateX: -1000 }}
                        animate={{ translateX: 0 }}
                        transition={{ duration: 2, type: "tween" }}
                        className="text-5xl text-left xl:text-[180px] leading-[0.9]"
                    >
                        {heading}
                    </motion.h1>
